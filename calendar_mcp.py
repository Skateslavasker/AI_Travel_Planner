...
if not GOOGLE_CLIENT_ID or not GOOGLE_CLIENT_SECRET or not GOOGLE_REFRESH_TOKEN:
  ...
  raise ValueError("Missing required environment variables for Google Calendar API")
...
async def create_event(
  ...
  try:
    ...
    "end_time": end_time,
    "calendar_link": response.get("htmlLink", "https://calendar.google.com/calendar/u/0/r?tab=mc")
    }
